...
Both tools are in scope for the same build phase — see Section 9 and BUSINESS_PLAN.md roadmap.
...
- [ ] Advanced tools pricing AND subscription tier structure (currently $50 flat one-time; subscription model now in scope, no pricing set) — pricing strategy session needed
