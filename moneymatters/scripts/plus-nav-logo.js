// §42.2/§45.1: for a logged-in Plus member, swap the standard nav wordmark
// icon for the real Plus-member mark (moneymatters-plus-mark.png) — a
// visual signal of membership status. Derives the swap path from the
...
(function () {
  function applyPlusNavLogo() {
    ...
    icon.setAttribute('src', dir + 'moneymatters-plus-mark.png');
