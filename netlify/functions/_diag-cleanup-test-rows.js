// Temporary — removes users/verification_tokens/advisor_review_requests
// test rows. Not part of the permanent function set; delete after use.
exports.handler = async () => {
  ...
  return {
    ...
    body: JSON.stringify({ users: await usersRes.text(), tokens: await tokensRes.text(), advisor: await advisorRes.text() }),
  };
};
